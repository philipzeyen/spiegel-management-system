...
<div class="row">
    <div class="col-md-12">
        <h2>Benutzer (<em>{{ $user->name }}</em>) ändern</h2>
        <form action="{{ url('user/edit', [$user->id]) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control" type="text" value="{{ $user->name }}" id="user_name" name="user_name" required minlength="5" />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input class="form-control" type="email" value="{{ $user->email }}" id="user_email" name="user_email" required />
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <span class="input-group-addon glyphicon glyphicon-envelope"></span>
                    <input class="form-control" type="email" id="user_email_confirmation" name="user_email_confirmation" required />
                </div>
            </div>
